...
def valid_move_horizontal_check(board):
...
def valid_move_vertical_check(board):
...
def check_for_loss(board):
    return not any(0 in row for row in board) and not valid_move_horizontal_check(board) and not valid_move_vertical_check(board)
